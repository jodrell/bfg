...
with having randomly generated [Leadership](the-rules.md#leadership).
...
[squadrons](squadrons.md) can overcome the worst effects of
...
The alternating [turn sequence](the-turn.md#turn-sequence) is clunky but
...
ships move when or use a Player A moves/Player B shoots principle, etc. (yes, I really
...
target “on the line” between two of its [fire arcs](the-shooting-phase.md#fire-arcs)
...
‘regenerated’ by the presence of [Blast markers](the-shooting-phase.md#blast-markers).
