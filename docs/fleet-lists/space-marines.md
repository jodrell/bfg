...
randomly generating the [Leadership](../the-rules.md#leadership) value for
...
In a [Planetary Assault](../scenarios/planetary-assault.md) scenario, Space Marine
...
1 point as is normal. In an [Exterminatus](../scenarios/exterminatus.md)
...
as [weapon batteries](../the-shooting-phase.md#direct-firing-weapons-batteries) with two exceptions:

1. Bombardment cannons always hit on a 4
or more, regardless of the target’s armour
(even vs [ordnance](../the-ordnance-phase.md)).
2. Bombardment cannons inflict [critical hits](../the-shooting-phase.md#critical-hits)
...
torpedoes](../the-ordnance-phase.md#boarding-torpedoes) instead of ordinary torpedoes, as
...
[resilient](../the-ordnance-phase.md#resilient-attack-craft), roll a dice when this happens. On a
score of 4+, do not remove the Thunderhawk
marker (However, Thunderhawks can
only remove one enemy marker in any
given [ordnance phase](../the-ordnance-phase.md) and stop moving as
...
treated exactly like [assault boats](../the-ordnance-phase.md#assault-boats) (with the +1
bonus to their [hit and run attack](../the-end-phase.md#hit-and-run-attacks) for being
...
Any vessel that earns or pays for a [refit](../campaign-rules.md#refits) to
...
they are extremely [resilient](../the-ordnance-phase.md#resilient-attack-craft) and follow all
...
during a [planetary assault](../scenarios/planetary-assault.md) instead of +1.
...
attacks](../the-end-phase.md#teleport-attacks) apply, except that they may be used
...
run [teleport attack](../the-end-phase.md#teleport-attacks). They roll two dice for
its [hit and run attack](../the-end-phase.md#hit-and-run-attacks) and apply both results,
...
A Space Marine Crusade fleet with a fortress-monastery will always be the defender in a
