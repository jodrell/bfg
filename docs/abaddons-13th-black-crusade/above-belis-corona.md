# Scenario Four: Above Belis Corona

_**A massive influx of Imperial reinforcements are making their way to the
...
much havoc as possible before further Imperial reinforcements arrive.**_
...
an extra [Re-roll](../the-rules.md#re-rolls) for free. In addition to
...
the [planet](../the-battlefield.md#planets) Belis Corona in the dead
centre of the table. This planet’s gravity
well extends 30 cm. Each player places
an [asteroid field](../the-battlefield.md#asteroid-fields) anywhere on the table
