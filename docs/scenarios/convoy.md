...
The convoy could be attacked near a [planet](../the-battlefield.md#planets),
or out in [deep space](../the-battlefield.md#6-deep-space-generator), so set up [celestial
phenomena](../the-battlefield.md#celestial-phenomena) in any mutually agreed fashion.
...
Once the convoy player’s [Movement Phase](../the-movement-phase.md)
...
[Movement Phase](../the-movement-phase.md) to represent his forces
...
Strength [torpedo](../the-ordnance-phase.md#torpedoes) salvo. The attacking
...
moving in the next [Ordnance Phase](../the-ordnance-phase.md).
...
Place one ship from the [squadron](../squadrons.md) on top of
